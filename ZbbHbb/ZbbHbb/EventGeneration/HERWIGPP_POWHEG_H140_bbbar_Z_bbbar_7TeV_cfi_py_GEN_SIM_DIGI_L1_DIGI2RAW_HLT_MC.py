...
# with command line options: HERWIGPP_POWHEG_H140_bbbar_Z_bbbar_7TeV_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --conditions FrontierConditions_GlobalTag,MC_42_V13::All --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/HERWIGPP_POWHEG_H140_bbbar_Z_bb_7TeV_cfi.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HERWIGPP_POWHEG_H140_bbbar_Z_bbbar_7TeV_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
