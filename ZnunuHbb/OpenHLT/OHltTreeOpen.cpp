			    ...
			    int it)
{
  ...
  vector<TString> r9Id;
	...
	static TH1F *h_CaloJet2_pT=new TH1F("h_CaloJet2_pT", "HLT Calo Jet 2 p_T; p_T (GeV)", 100, 0., 400.);
	...
	static TH1F *h_L1ETM36wrtCaloMET_den=new TH1F("h_L1ETM36wrtCaloMET_den", "L1 ETM36 Response w.r.t. HLT Calo MET; L1 ETM (GeV)", 100, 0., 400.);
	
	static TH1F *h_CaloMET80wrtPFMHT_num=new TH1F("h_CaloMET80wrtPFMHT_num", "L1 ETM 36 && CaloMET80 Response w.r.t. HLT PF MHT; PF MHT (GeV)", 100, 0., 400.);
	static TH1F *h_CaloMET80wrtPFMHT_den=new TH1F("h_CaloMET80wrtPFMHT_den", "L1 ETM 36 && CaloMET80 Response w.r.t. HLT PF MHT; PF MHT (GeV)", 100, 0., 400.);
	
	// 2-D correlation histograms
	static TH2F *h_CaloJet_PFJet=new TH2F("h_CaloJet_PFJet", "PF Jet pT vs Calo Jet pT; Calo Jet pT (GeV); PF Jet pT (GeV)", 100, 0., 100., 100, 0., 100.);
